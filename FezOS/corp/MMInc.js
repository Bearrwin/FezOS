...
export async function main(ns) {
	...
	let hwAgriGoal2 = Math.min(1791 * 1.55);
	let roAgriGoal2 = 0;
	let aiAgriGoal2 = Math.min(1562 * 1.55);
	let reAgriGoal2 = Math.min(98470 * 1.55);

	let hwChemGoal2 = Math.min(3194 * 0.7);
	let roChemGoal2 = Math.min(54 * 0.7); 
	let aiChemGoal2 = Math.min(1717 * 0.7);
	let reChemGoal2 = Math.min(54917 * 0.7) ;
